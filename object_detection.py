...
def main():
    ...
    #initializing object detection parameters 
    obj_param = sl.ObjectDetectionParameters()
    obj_param.enable_tracking = True 
    obj_param.enable_segmentation = True    
    obj_param.detection_model = sl.OBJECT_DETECTION_MODEL.MULTI_CLASS_BOX_ACCURATE  #set the model you want

    if obj_param.enable_tracking == True:
        positional_tracking_param = sl.PositionalTrackingParameters()
        #positional_tracking_param.set_as_static = True   #set true when camera is static
    ...
    objects = sl.Objects() #detection output data goes here
    ...
    for i in range(100):
        ...
        if objects.is_new:   #AI finished calculations 
